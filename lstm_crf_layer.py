...
class BLSTM_CRF(object):
    def __init__(self, embedded_chars, hidden_unit, cell_type,num_layers, droupout_rate,
        ...
        """
        self.hidden_unit = hidden_unit  # [10*10000] [10000*n]
    ...
    def blstm_layer(self, embedding_chars):
        ...
        with tf.variable_scope('rnn_layer'):
            ...
            if self.num_layers > 1:
                cell_fw = rnn.MultiRNNCell([cell_fw for _ in len(self.num_layers)]  , state_is_tuple=True)
                cell_bw = rnn.MultiRNNCell([cell_bw for _ in len(self.num_layers)], state_is_tuple=True)
